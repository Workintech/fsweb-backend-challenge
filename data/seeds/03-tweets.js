...
exports.seed = async function(knex) {
  ...
  await knex('tweets').insert([
    ...
    {tweet:'Bende okumak istiyordum o kitabi, hemen alacagim',parent_id:4,created_at:"2023-07-11 09:06:00",user_id:3},
    {tweet:'Bende alacagim bugun',parent_id:7,created_at:"2023-07-11 09:07:00",user_id:3},
    ...
    {tweet:'bende okudum guzel kitap',parent_id:4,created_at:"2023-07-11 09:10:00",user_id:1},
